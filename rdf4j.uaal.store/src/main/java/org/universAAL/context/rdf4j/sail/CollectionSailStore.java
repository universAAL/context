 ...
 * and enforce cardinality 1 of closed collections
 */
class CollectionSailStore implements SailStore {

	final Logger logger = LoggerFactory.getLogger(CollectionSailStore.class);
	...
	/**
	 * Creates a new {@link CollectionSailStore} with the default cache sizes.
	 */
	public CollectionSailStore(File dataDir, String tripleIndexes)
	...
	/**
	 * Creates a new {@link CollectionSailStore}.
	 */
	public CollectionSailStore(File dataDir, String tripleIndexes, boolean forceSync, int valueCacheSize,
