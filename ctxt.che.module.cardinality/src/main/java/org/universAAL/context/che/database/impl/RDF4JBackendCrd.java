 ...
 * that uses a modified RDF4J NativeStore that checks cardinality of stored
 ...
 *
 */
public class RDF4JBackendCrd extends RDF4JBackend {
	/**
	 * logger.
	 */
	private static Log log = Hub.getLog(RDF4JBackendCrd.class);
