...
public class SCalleeProvidedService extends ProfilingService {
    ...
    protected static final String SRV_GET_SERVS_OF_SPACE = NAMESPACE
	    + "servGetServicesOfSpace";
    ...
    protected static final String SRV_GET_DEVS_OF_SPACE = NAMESPACE
	    + "servGetDevicesOfSpace";
    ...
    protected static final String SRV_GET_ONTS_OF_SPACE = NAMESPACE
	    + "servGetOntsOfSpace";
    ...
    protected static final String SRV_GET_HR_OF_SERV = NAMESPACE
	    + "servGetHumanResourceOfService";
    ...
    protected static final String SRV_GET_HW_OF_SERV = NAMESPACE
	    + "servGetHardwareOfService";
    ...
    protected static final String SRV_GET_APP_OF_SERV = NAMESPACE
	    + "servGetAppOfService";
    ...
    protected static final String SRV_ADD_SERV_TO_SPACE = NAMESPACE
	    + "servAddServiceToSpace";
    protected static final String INP_ADD_SERV_TO_SPACE_WHERE = NAMESPACE
	    + "servJ1";
    protected static final String INP_ADD_SERV_TO_SPACE_WHAT = NAMESPACE
	    + "servJ2";
    protected static final String SRV_ADD_DEV_TO_SPACE = NAMESPACE
	    + "servAddDeviceToSpace";
    protected static final String INP_ADD_DEV_TO_SPACE_WHERE = NAMESPACE
	    + "servK1";
    protected static final String INP_ADD_DEV_TO_SPACE_WHAT = NAMESPACE
	    + "servK2";
    protected static final String SRV_ADD_ONT_TO_SPACE = NAMESPACE
	    + "servAddOntologyToSpace";
    protected static final String INP_ADD_ONT_TO_SPACE_WHERE = NAMESPACE
	    + "servL1";
    protected static final String INP_ADD_ONT_TO_SPACE_WHAT = NAMESPACE
	    + "servL2";
    protected static final String SRV_ADD_PROF_TO_SPACE = NAMESPACE
	    + "servAddProfileToSpace";
    protected static final String INP_ADD_PROF_TO_SPACE_WHERE = NAMESPACE
	    + "servM1";
    protected static final String INP_ADD_PROF_TO_SPACE_WHAT = NAMESPACE
	    + "servM2";
    protected static final String SRV_ADD_PROF_TO_SERV = NAMESPACE
	    + "servAddProfileToService";
    protected static final String INP_ADD_PROF_TO_SERV_WHERE = NAMESPACE
	    + "servN1";
    protected static final String INP_ADD_PROF_TO_SERV_WHAT = NAMESPACE
	    + "servN2";
    protected static final String SRV_GET_OWNERS_OF_SPACE = NAMESPACE
	    + "servGetOwnersOfSpace";
    ...
    protected static final String SRV_GET_OWNERS_OF_SERV = NAMESPACE
	    + "servGetOwnersOfService";
    ...
    protected static final String SRV_ADD_OWNER_TO_SPACE = NAMESPACE
	    + "servAddOwnerToSpace";
    protected static final String INP_ADD_OWNER_TO_SPACE_WHERE = NAMESPACE
	    + "servQ1";
    protected static final String INP_ADD_OWNER_TO_SPACE_WHAT = NAMESPACE
	    + "servQ2";
    protected static final String SRV_ADD_OWNER_TO_SERV = NAMESPACE
	    + "servAddOwnerToService";
    protected static final String INP_ADD_OWNER_TO_SERV_WHERE = NAMESPACE
	    + "servR1";
    protected static final String INP_ADD_OWNER_TO_SERV_WHAT = NAMESPACE
	    + "servR2";
    protected static final String SRV_GET_PROF_OF_SPACE = NAMESPACE
	    + "servGetProfileOfSpace";
    ...
    protected static final String SRV_GET_PROF_OF_SERV = NAMESPACE
	    + "servGetProfileOfService";
	...
	prof0.addOutput(OUT_GET_SERVS, AALService.MY_URI, 0, -1,
	...
	SCalleeProvidedService prof1 = new SCalleeProvidedService(
		SRV_GET_SPACES);
	prof1.addOutput(OUT_GET_SPACES, AALSpace.MY_URI, 0, -1,
		new String[] { ProfilingService.PROP_CONTROLS });
	...
	prof2.addFilteringInput(INP_GET_SERVS_OF_SPACE, AALSpace.MY_URI, 1, 1,
		new String[] { ProfilingService.PROP_CONTROLS });
	prof2.addOutput(OUT_GET_SERVS_OF_SPACE, AALService.MY_URI, 0, -1,
		new String[] { ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE,
			AALSpaceProfile.PROP_INSTALLED_SERVICES });
	...
	prof3.addFilteringInput(INP_GET_DEVS_OF_SPACE, AALSpace.MY_URI, 1, 1,
		new String[] { ProfilingService.PROP_CONTROLS });
	prof3.addOutput(OUT_GET_DEVS_OF_SPACE, Device.MY_URI, 0, -1,
		new String[] { ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE,
	...
	prof5.addFilteringInput(INP_GET_HR_OF_SERV, AALService.MY_URI, 1, 1,
		new String[] { ProfilingService.PROP_CONTROLS });
	prof5.addOutput(OUT_GET_HR_OF_SERV, HRSubProfile.MY_URI, 0, -1,
		new String[] { ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE,
	...
	prof6.addFilteringInput(INP_GET_HW_OF_SERV, AALService.MY_URI, 1, 1,
		new String[] { ProfilingService.PROP_CONTROLS });
	prof6.addOutput(OUT_GET_HW_OF_SERV, HWSubProfile.MY_URI, 0, -1,
		new String[] { ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE,
	...
	SCalleeProvidedService prof8 = new SCalleeProvidedService(
		SRV_ADD_SERV_TO_SPACE);
	prof8.addFilteringInput(INP_ADD_SERV_TO_SPACE_WHERE, AALSpace.MY_URI,
		1, 1, new String[] { ProfilingService.PROP_CONTROLS });
	prof8.addInputWithAddEffect(INP_ADD_SERV_TO_SPACE_WHAT,
		AALService.MY_URI, 1, 1, new String[] {
	...
	SCalleeProvidedService prof9 = new SCalleeProvidedService(
		SRV_ADD_DEV_TO_SPACE);
	prof9.addFilteringInput(INP_ADD_DEV_TO_SPACE_WHERE, AALSpace.MY_URI, 1,
		1, new String[] { ProfilingService.PROP_CONTROLS });
	prof9.addInputWithAddEffect(INP_ADD_DEV_TO_SPACE_WHAT, Device.MY_URI,
		1, 1, new String[] { ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE,
			AALSpaceProfile.PROP_INSTALLED_HARDWARE });
	...
	SCalleeProvidedService prof10 = new SCalleeProvidedService(
		SRV_ADD_ONT_TO_SPACE);
	prof10.addFilteringInput(INP_ADD_ONT_TO_SPACE_WHERE, AALSpace.MY_URI,
		1, 1, new String[] { ProfilingService.PROP_CONTROLS });
	prof10.addInputWithAddEffect(INP_ADD_ONT_TO_SPACE_WHAT,
		OntologyEntry.MY_URI, 1, 1, new String[] {
			ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE,
			AALSpaceProfile.PROP_INSTALLED_ONTOLOGIES });
	...
	SCalleeProvidedService prof11 = new SCalleeProvidedService(
		SRV_ADD_PROF_TO_SPACE);
	prof11.addFilteringInput(INP_ADD_PROF_TO_SPACE_WHERE, AALSpace.MY_URI,
		1, 1, new String[] { ProfilingService.PROP_CONTROLS });
	prof11.addInputWithAddEffect(INP_ADD_PROF_TO_SPACE_WHAT,
		AALSpaceProfile.MY_URI, 1, 1, new String[] {
			ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE });
	...
	SCalleeProvidedService prof12 = new SCalleeProvidedService(
		SRV_ADD_PROF_TO_SERV);
	prof12.addFilteringInput(INP_ADD_PROF_TO_SERV_WHERE, AALService.MY_URI,
		1, 1, new String[] { ProfilingService.PROP_CONTROLS });
	prof12.addInputWithAddEffect(INP_ADD_PROF_TO_SERV_WHAT,
		AALServiceProfile.MY_URI, 1, 1, new String[] {
			ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE });
	...
	// which URI matches the one of the passed parameter
	SCalleeProvidedService prof13 = new SCalleeProvidedService(
		SRV_GET_OWNERS_OF_SPACE);
	prof13.addFilteringInput(INP_GET_OWNERS_OF_SPACE, AALSpace.MY_URI, 1,
		1, new String[] { ProfilingService.PROP_CONTROLS });
	prof13.addOutput(OUT_GET_OWNERS_OF_SPACE, User.MY_URI, 0, -1,
		new String[] { ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE,
			AALSpaceProfile.PROP_SPACE_OWNER });
	profiles[13] = prof13.getProfile();

	// GET_OWNERS(AALService) -> [User]
	// Returns the Users (only their URIs) owning a AALService
	// which URI matches the one of the passed parameter
	SCalleeProvidedService prof14 = new SCalleeProvidedService(
		SRV_GET_OWNERS_OF_SERV);
	prof14.addFilteringInput(INP_GET_OWNERS_OF_SERV, AALService.MY_URI, 1,
		1, new String[] { ProfilingService.PROP_CONTROLS });
	prof14.addOutput(OUT_GET_OWNERS_OF_SERV, User.MY_URI, 0, -1,
		new String[] { ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE,
			AALServiceProfile.PROP_SERVICE_OWNER });
	...
	SCalleeProvidedService prof15 = new SCalleeProvidedService(
		SRV_ADD_OWNER_TO_SPACE);
	prof15.addFilteringInput(INP_ADD_OWNER_TO_SPACE_WHERE, AALSpace.MY_URI,
		1, 1, new String[] { ProfilingService.PROP_CONTROLS });
	prof15.addInputWithAddEffect(INP_ADD_OWNER_TO_SPACE_WHAT, User.MY_URI,
		1, 1, new String[] { ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE,
			AALSpaceProfile.PROP_SPACE_OWNER });
	...
	SCalleeProvidedService prof16 = new SCalleeProvidedService(
		SRV_ADD_OWNER_TO_SERV);
	prof16.addFilteringInput(INP_ADD_OWNER_TO_SERV_WHERE,
		AALService.MY_URI, 1, 1,
		new String[] { ProfilingService.PROP_CONTROLS });
	prof16.addInputWithAddEffect(INP_ADD_OWNER_TO_SERV_WHAT, User.MY_URI,
		1, 1, new String[] { ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE,
			AALServiceProfile.PROP_SERVICE_OWNER });
	...
	// which URI matches the one of the passed parameter
	SCalleeProvidedService prof17 = new SCalleeProvidedService(
	...
	// Returns the AALServiceProfile of a AALService
	// which URI matches the one of the passed parameter
	SCalleeProvidedService prof18 = new SCalleeProvidedService(
