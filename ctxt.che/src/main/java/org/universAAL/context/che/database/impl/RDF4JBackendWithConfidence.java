...
/**
 * Extension of {@link org.universAAL.context.che.database.impl.RDF4JBackend}
 ...
 * as in {@link org.universAAL.context.che.database.impl.RDF4JBackend}.
 ...
 *
 */
public class RDF4JBackendWithConfidence extends RDF4JBackend {
	/**
	 * Logger.
	 */
	private static Log log = Hub.getLog(RDF4JBackendWithConfidence.class);
	/**
	 ...
	 * Main constructor.
	 */
	public RDF4JBackendWithConfidence() {
		super();
	 ...
	 *            Threshold for confidence
	 */
	public RDF4JBackendWithConfidence(int confidence) {
		super();
	 ...
	 *
	 * @see
	 * org.universAAL.context.che.database.impl.RDF4JBackend#storeEvent(org
