 ...
 */
public class CollectionStoreConnection extends SailSourceConnection {

	/*-----------*
	 * Constants *
	 *-----------*/

	protected final CollectionStore nativeStore;
	...
	protected CollectionStoreConnection(CollectionStore sail)
		throws IOException
	{
