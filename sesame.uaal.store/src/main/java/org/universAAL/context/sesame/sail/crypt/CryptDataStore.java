...
public class CryptDataStore extends DataStore {
	...
	public CryptDataStore(File dataDir, String filePrefix, boolean forceSync) throws IOException {
		...
		File confHome = new File(
				new File(System.getProperty("bundles.configuration.location", System.getProperty("user.dir"))),
	...
	// org.openrdf.sesame.sailimpl.nativerdf.datastore.DataStore <data-dir>
	// <file-prefix>");
	// return;
	// }
	//
