...
public class SCallee extends ServiceCallee {
    ...
    private static final ServiceResponse ERROR_EMPTY = new ServiceResponse(
	    CallStatus.serviceSpecificFailure);
    /**
	...
	ERROR_EMPTY.addOutput(
		new ProcessOutput(ServiceResponse.PROP_SERVICE_SPECIFIC_ERROR,
	...
	this.addNewServiceProfiles(SCalleeProvidedService.getServiceProfiles(
		...
		new String[] { ProfilingService.PROP_CONTROLS }, User.MY_URI));
	this.addNewServiceProfiles(SCalleeProvidedService
		.getServiceProfiles(NAMESPACE_PROFILE, ProfilingService.MY_URI,
			new String[] { ProfilingService.PROP_CONTROLS,
				Profilable.PROP_HAS_PROFILE },
			UserProfile.MY_URI));
	this.addNewServiceProfiles(SCalleeProvidedService.getServiceProfiles(
		NAMESPACE_SUBPROFILE, ProfilingService.MY_URI,
		new String[] { ProfilingService.PROP_CONTROLS,
			Profilable.PROP_HAS_PROFILE,
	...
	try {
	    ...
	    if (operation.startsWith(
		    NAMESPACE_PROFILABLE + SCalleeProvidedService.SRV_GET_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: GET_PROFILABLE_DETAILS" },
			null);
		...
		if (result != null) {
		    response.addOutput(new ProcessOutput(
			    NAMESPACE_PROFILABLE
				    + SCalleeProvidedService.OUT_GET_X,
			    result));
		} else {
		    return ERROR_EMPTY;
		}
	    ...
	    if (operation.startsWith(
		    NAMESPACE_PROFILABLE + SCalleeProvidedService.SRV_ADD_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
	    ...
	    if (operation.startsWith(
		    NAMESPACE_PROFILABLE + SCalleeProvidedService.SRV_CHN_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
	    ...
	    if (operation.startsWith(
		    NAMESPACE_PROFILABLE + SCalleeProvidedService.SRV_REM_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
	    ...
	    if (operation.startsWith(
		    NAMESPACE_PROFILE + SCalleeProvidedService.SRV_GET_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: GET_PROFILE_DETAILS" }, null);
		Object input = call.getInputValue(
			NAMESPACE_PROFILE + SCalleeProvidedService.INP_GET_X);
		if (input == null) {
		    return ERROR_INPUT;
		}
	    ...
	    if (operation.startsWith(
		    NAMESPACE_PROFILE + SCalleeProvidedService.SRV_ADD_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: ADD_PROFILE" }, null);
		Object input = call.getInputValue(
			NAMESPACE_PROFILE + SCalleeProvidedService.INP_ADD_X);
		if (input == null) {
		    return ERROR_INPUT;
		}
	    ...
	    if (operation.startsWith(
		    NAMESPACE_PROFILE + SCalleeProvidedService.SRV_CHN_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: CHANGE_PROFILE" }, null);
		Object input = call.getInputValue(
			NAMESPACE_PROFILE + SCalleeProvidedService.INP_CHN_X);
		if (input == null) {
		    return ERROR_INPUT;
		}
	    ...
	    if (operation.startsWith(
		    NAMESPACE_PROFILE + SCalleeProvidedService.SRV_REM_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: REMOVE_PROFILE" }, null);
		Object input = call.getInputValue(
			NAMESPACE_PROFILE + SCalleeProvidedService.INP_REM_X);
		if (input == null) {
		    return ERROR_INPUT;
		}
	    ...
	    if (operation.startsWith(
		    NAMESPACE_SUBPROFILE + SCalleeProvidedService.SRV_GET_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: GET_SUBPROFILE_DETAILS" },
			null);
	    ...
	    if (operation.startsWith(
		    NAMESPACE_SUBPROFILE + SCalleeProvidedService.SRV_ADD_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
	    ...
	    if (operation.startsWith(
		    NAMESPACE_SUBPROFILE + SCalleeProvidedService.SRV_CHN_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
	    ...
	    if (operation.startsWith(
		    NAMESPACE_SUBPROFILE + SCalleeProvidedService.SRV_REM_X)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
	    ...
	    if (operation
		    .startsWith(SCalleeProvidedService.SRV_GET_PRF_OF_USR)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: SRV_GET_PRF_OF_USR" }, null);
		Object input = call.getInputValue(
			SCalleeProvidedService.INP_GET_PRF_OF_USR);
		if (input == null) {
		    return ERROR_INPUT;
		}
	    ...
	    if (operation
		    .startsWith(SCalleeProvidedService.SRV_GET_SUBS_OF_USR)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: SRV_GET_SUBS_OF_USR" }, null);
		Object input = call.getInputValue(
			SCalleeProvidedService.INP_GET_SUBS_OF_USR);
		if (input == null) {
		    return ERROR_INPUT;
		}
		...
		if (result != null) {
		    response.addOutput(new ProcessOutput(
			    SCalleeProvidedService.OUT_GET_SUBS_OF_USR,
			    result));
		} else {
		    return ERROR_EMPTY;
		}
	    ...
	    if (operation
		    .startsWith(SCalleeProvidedService.SRV_GET_SUB_OF_USR)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: SRV_GET_SUB_OF_USR" }, null);
		Object input = call.getInputValue(
			SCalleeProvidedService.INP_GET_SUB_OF_USR);
		if (input == null) {
		    return ERROR_INPUT;
		}
		// Resource result = Hub.scaller
	    ...
	    if (operation
		    .startsWith(SCalleeProvidedService.SRV_GET_SUBS_OF_PRF)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: SRV_GET_SUBS_OF_PRF" }, null);
		Object input = call.getInputValue(
			SCalleeProvidedService.INP_GET_SUBS_OF_PRF);
		if (input == null) {
		    return ERROR_INPUT;
		}
		ArrayList result = Hub.scaller
		...
		if (result != null) {
		    response.addOutput(new ProcessOutput(
			    SCalleeProvidedService.OUT_GET_SUBS_OF_PRF,
			    result));
		} else {
		    return ERROR_EMPTY;
		}
	    ...
	    if (operation
		    .startsWith(SCalleeProvidedService.SRV_ADD_PRF_TO_USR)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: SRV_ADD_PRF_TO_USR" }, null);
		Object inWhere = call.getInputValue(
			SCalleeProvidedService.IN_ADD_PRF_TO_USR_WHERE);
		Object inWhat = call.getInputValue(
			SCalleeProvidedService.IN_ADD_PRF_TO_USR_WHAT);
		if (inWhere == null || inWhat == null) {
		    return ERROR_INPUT;
		}
		Hub.scaller.addProfileToUser((Resource) inWhere,
			(Resource) inWhat);
		ServiceResponse response = new ServiceResponse(
			CallStatus.succeeded);
		return response;
	    ...
	    if (operation
		    .startsWith(SCalleeProvidedService.SRV_ADD_SUB_TO_USR)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: SRV_ADD_SUB_TO_USR" }, null);
		Object inWhere = call.getInputValue(
			SCalleeProvidedService.IN_ADD_SUB_TO_USR_WHERE);
		Object inWhat = call.getInputValue(
			SCalleeProvidedService.IN_ADD_SUB_TO_USR_WHAT);
		if (inWhere == null || inWhat == null) {
		    return ERROR_INPUT;
		}
		Hub.scaller.addSubProfileToUser((Resource) inWhere,
			(Resource) inWhat);
		ServiceResponse response = new ServiceResponse(
			CallStatus.succeeded);
		return response;
	    ...
	    if (operation
		    .startsWith(SCalleeProvidedService.SRV_ADD_SUB_TO_PRF)) {
		LogUtils.logDebug(mc, SCallee.class, "handleCall",
			new String[] { "CALLED: SRV_ADD_SUB_TO_PRF" }, null);
		Object inWhere = call.getInputValue(
			SCalleeProvidedService.IN_ADD_SUB_TO_PRF_WHERE);
		Object inWhat = call.getInputValue(
			SCalleeProvidedService.IN_ADD_SUB_TO_PRF_WHAT);
		if (inWhere == null || inWhat == null) {
		    return ERROR_INPUT;
		}
		Hub.scaller.addSubProfileToProf((Resource) inWhere,
			(Resource) inWhat);
		ServiceResponse response = new ServiceResponse(
			CallStatus.succeeded);
		return response;
	    ...
	    ServiceResponse fail = new ServiceResponse(
		    CallStatus.serviceSpecificFailure);
	    fail.addOutput(new ProcessOutput(
		    ServiceResponse.PROP_SERVICE_SPECIFIC_ERROR,
