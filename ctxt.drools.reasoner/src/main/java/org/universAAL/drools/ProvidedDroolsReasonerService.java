...
public class ProvidedDroolsReasonerService extends DroolsReasoning {
	...
	public static final String MY_URI = DROOLS_REASONER_NAMESPACE + "ProvidedDroolsReasonerService";
	// Rule managing
	public static final String SERVICE_ADD_RULE = DROOLS_REASONER_NAMESPACE + "addRule";
	public static final String SERVICE_REMOVE_RULE = DROOLS_REASONER_NAMESPACE + "removeRule";
	public static final String SERVICE_MODIFY_RULE = DROOLS_REASONER_NAMESPACE + "modifyRule";
	// Fact managing
	public static final String SERVICE_ADD_FACT = DROOLS_REASONER_NAMESPACE + "addFact";
	public static final String SERVICE_REMOVE_FACT = DROOLS_REASONER_NAMESPACE + "removeFact";
	public static final String SERVICE_MODIFY_FACT = DROOLS_REASONER_NAMESPACE + "modifyFact";
	// Consequence managing
	public static final String SERVICE_FIRE_CONSEQUENCE = DROOLS_REASONER_NAMESPACE + "fireConsequence";
	// LTBA ON
	...
	// Input rule
	public static final String INPUT_RULE = DROOLS_REASONER_NAMESPACE + "inputRule";
	// Input fact
	public static final String INPUT_FACT = DROOLS_REASONER_NAMESPACE + "inputFact";
	// Input ruleID
	public static final String INPUT_RULE_ID = DROOLS_REASONER_NAMESPACE + "inputRuleId";
	// Input factID
	public static final String INPUT_FACT_ID = DROOLS_REASONER_NAMESPACE + "inputFactId";
	...
	static {
		OntologyManagement.getInstance().register(Activator.mc,
				new SimpleOntology(MY_URI, DroolsReasoning.MY_URI, new ResourceFactory() {
					public Resource createInstance(String classURI, String instanceURI, int factoryIndex) {
						return new ProvidedDroolsReasonerService(instanceURI);
					}
				}));
		// AddRule

		ProvidedDroolsReasonerService addRule = new ProvidedDroolsReasonerService(SERVICE_ADD_RULE);
		...
		addRule.addFilteringInput(INPUT_RULE, Rule.MY_URI, 1, 1, new String[] { DroolsReasoning.PROP_KNOWS_RULES });
		...
		addRule.myProfile.addAddEffect(new String[] { DroolsReasoning.PROP_KNOWS_RULES }, input1);
		profiles[0] = addRule.myProfile;
		// RemoveRule
		ProvidedDroolsReasonerService removeRule = new ProvidedDroolsReasonerService(SERVICE_REMOVE_RULE);
		...
		MergedRestriction restr2 = MergedRestriction.getFixedValueRestriction(Rule.PROP_HAS_IDENTIFIER,
				input2.asVariableReference());
		removeRule.addInstanceLevelRestriction(restr2,
				new String[] { DroolsReasoning.PROP_KNOWS_RULES, Rule.PROP_HAS_IDENTIFIER });
		removeRule.getProfile()
				.addRemoveEffect(new String[] { DroolsReasoning.PROP_KNOWS_RULES, Rule.PROP_HAS_IDENTIFIER });
		profiles[1] = removeRule.myProfile;

		// ModifyRule
		ProvidedDroolsReasonerService modifyRule = new ProvidedDroolsReasonerService(SERVICE_MODIFY_RULE);
		ProcessInput input3 = new ProcessInput(INPUT_RULE);
		input3.setParameterType(Rule.MY_URI);
		modifyRule.addFilteringInput(INPUT_RULE, Rule.MY_URI, 1, 1, new String[] { DroolsReasoning.PROP_KNOWS_RULES });
		modifyRule.myProfile.addChangeEffect(new String[] { DroolsReasoning.PROP_KNOWS_RULES }, input3);
		profiles[2] = modifyRule.myProfile;

		// AddFact
		ProvidedDroolsReasonerService addFact = new ProvidedDroolsReasonerService(SERVICE_ADD_FACT);
		ProcessInput input4 = new ProcessInput(INPUT_FACT);
		input4.setParameterType(Fact.MY_URI);
		addFact.addFilteringInput(INPUT_FACT, Fact.MY_URI, 1, 1, new String[] { DroolsReasoning.PROP_KNOWS_FACTS });
		addFact.myProfile.addAddEffect(new String[] { DroolsReasoning.PROP_KNOWS_FACTS }, input4);
		profiles[3] = addFact.myProfile;

		// ModifyFact
		ProvidedDroolsReasonerService modifyFact = new ProvidedDroolsReasonerService(SERVICE_MODIFY_FACT);
		ProcessInput input6 = new ProcessInput(INPUT_FACT);
		input6.setParameterType(Fact.MY_URI);
		modifyFact.addFilteringInput(INPUT_FACT, Fact.MY_URI, 1, 1, new String[] { DroolsReasoning.PROP_KNOWS_FACTS });
		modifyFact.myProfile.addChangeEffect(new String[] { DroolsReasoning.PROP_KNOWS_FACTS }, input6);
		profiles[4] = modifyFact.myProfile;

		// RemoveFact
		ProvidedDroolsReasonerService removeFact = new ProvidedDroolsReasonerService(SERVICE_REMOVE_FACT);
		...
		MergedRestriction restr3 = MergedRestriction.getFixedValueRestriction(Fact.PROP_HAS_IDENTIFIER,
				input7.asVariableReference());
		removeFact.addInstanceLevelRestriction(restr3,
				new String[] { DroolsReasoning.PROP_KNOWS_FACTS, Fact.PROP_HAS_IDENTIFIER });
		removeFact.getProfile()
				.addRemoveEffect(new String[] { DroolsReasoning.PROP_KNOWS_FACTS, Fact.PROP_HAS_IDENTIFIER });
