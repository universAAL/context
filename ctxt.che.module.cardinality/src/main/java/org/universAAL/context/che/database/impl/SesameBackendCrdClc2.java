 ...
 * 
 */
public class SesameBackendCrdClc2 extends SesameBackend {
    /**
     * Logger.
     */
    private static Log log = Hub.getLog(SesameBackendCrdClc2.class);
	...
	if (dataPath != null) {
	    ...
	    log.error("connect",
		    "No location specified for the store. Add and "
			    + "specify the configuration parameter "
			    + "STORE.LOCATION to the configuration"
			    + " file of the CHE pointing to a valid"
			    + " folder path.");
	}
    }
