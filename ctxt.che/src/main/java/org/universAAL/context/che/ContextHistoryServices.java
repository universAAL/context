...
public class ContextHistoryServices extends ContextHistoryService {
	...
	static {
		...
		MergedRestriction eventRestr = MergedRestriction.getFixedValueRestriction(ContextHistoryService.PROP_MANAGES,
		...
		MergedRestriction tstFromRestr = MergedRestriction.getFixedValueRestriction(
				ContextHistoryService.PROP_TIMESTAMP_FROM, tstFromInput.asVariableReference());

		MergedRestriction tstToRestr = MergedRestriction
				.getFixedValueRestriction(ContextHistoryService.PROP_TIMESTAMP_TO, tstToInput.asVariableReference());
