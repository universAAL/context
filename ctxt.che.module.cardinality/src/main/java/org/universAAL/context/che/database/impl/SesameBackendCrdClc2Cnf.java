...
import org.universAAL.context.sesame.sail.CardinCollect2NativeStore;

/**
 * Like a {@link org.universAAL.context.che.database.impl.SesameBackendCrdClc2}
 ...
 *
 */
public class SesameBackendCrdClc2Cnf extends SesameBackendWithConfidence {
	/**
	 * Logger.
	 */
	private static Log log = Hub.getLog(SesameBackendCrdClc2Cnf.class);
		...
		if (dataPath != null) {
			...
			try {
				myRepository = new SailRepository(
						new ForwardChainingRDFSInferencer(new CardinCollect2NativeStore(dataDir, indexes, encrypt)));
