...
/**
 * Extension of
 * {@link org.universAAL.context.che.database.impl.RDF4JBackendCrd} that uses a
 * modified RDF4J NativeStore that checks cardinality of stored statements,
 ...
 *
 */
public class RDF4JBackendCrdClc2 extends RDF4JBackend {
	/**
	 * Logger.
	 */
	private static Log log = Hub.getLog(RDF4JBackendCrdClc2.class);
