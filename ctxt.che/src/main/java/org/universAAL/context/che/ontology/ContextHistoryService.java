...
public class ContextHistoryService extends Service{
	...
	static{
		...
		addRestriction(
				Restriction.getAllValuesRestriction(PROP_MANAGES, ContextEvent.MY_URI),
				new String[] {PROP_MANAGES},
				CHRestrictions);
		addRestriction(
				Restriction.getAllValuesRestriction(PROP_PROCESSES, TypeMapper.getDatatypeURI(String.class)),
				new String[] {PROP_PROCESSES},
				CHRestrictions);
		addRestriction(
				Restriction.getAllValuesRestriction(PROP_RETURNS, TypeMapper.getDatatypeURI(String.class)),
				new String[] {PROP_RETURNS},
				CHRestrictions);
		addRestriction(
				Restriction.getAllValuesRestriction(PROP_TIMESTAMP_FROM, TypeMapper.getDatatypeURI(Long.class)),
				new String[] {PROP_TIMESTAMP_FROM},
				CHRestrictions);
		addRestriction(
				Restriction.getAllValuesRestriction(PROP_TIMESTAMP_TO, TypeMapper.getDatatypeURI(Long.class)),
				new String[] {PROP_TIMESTAMP_TO},
				CHRestrictions);
		addRestriction(
				Restriction.getAllValuesRestriction(PROP_DURATION_FROM, TypeMapper.getDatatypeURI(Duration.class)),
				new String[] {PROP_DURATION_FROM},
				CHRestrictions);
		addRestriction(
				Restriction.getAllValuesRestriction(PROP_DURATION_TO, TypeMapper.getDatatypeURI(Duration.class)),
				new String[] {PROP_DURATION_TO},
				CHRestrictions);
	}
	...
	public static Restriction getClassRestrictionsOnProperty(String propURI) {
		...
		return Service.getClassRestrictionsOnProperty(propURI);//WARNING. NOT IN MW C.E.
	}
	...
	public int getPropSerializationType(String propURI) {
		return PROP_MANAGES.equals(propURI)||
		PROP_PROCESSES.equals(propURI)||
		...
		PROP_DURATION_TO.equals(propURI)
