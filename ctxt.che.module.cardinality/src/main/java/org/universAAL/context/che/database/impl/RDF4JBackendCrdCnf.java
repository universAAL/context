...
/**
 * Like a {@link org.universAAL.context.che.database.impl.RDF4JBackendCrd} that
 ...
 *
 */
public class RDF4JBackendCrdCnf extends RDF4JBackendWithConfidence {
	/**
	 * Logger.
	 */
	private static final Log log = Hub.getLog(RDF4JBackendCrdCnf.class);
