...
public class ReliabilityReasonerActivator implements BundleActivator, ServiceListener {
	...
	// /**
	// * Reads a file looking for "situations", described as statements just
	// like
	...
	// * ...
	// * <p>
	// * Predicate and object URI are optional. This statement describes loosely
	// a
	...
	// * IDQuery.txt, being ID the id expressed in the previous file. The
	// content
