 ...
 * 
 * PATCH UAAL: Copied from NativeStoreConnection and modified to allow encryption and enforce cardinality 1
 */
public class CardinalityStoreConnection extends SailSourceConnection {

	/*-----------*
	 * Constants *
	 *-----------*/

	protected final CardinalityStore nativeStore;
	...
	protected CardinalityStoreConnection(CardinalityStore sail)
		throws IOException
	{
