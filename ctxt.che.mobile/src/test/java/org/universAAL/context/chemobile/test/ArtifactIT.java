...
public class ArtifactIT extends IntegrationTest {
	...
	public void testStore() {
		LogUtils.logInfo(Activator.getModuleContext(), ArtifactIT.class, "testStore", new String[] { "-Test 2-" },
				null);
		...
		LogUtils.logInfo(Activator.getModuleContext(), ArtifactIT.class, "testStore",
				new String[] { "Created Default Context Publisher with full Provider Info" }, null);
		...
		File fileref = new File(Activator.getModuleContext().getConfigHome(), "Mobile-Events.txt");
