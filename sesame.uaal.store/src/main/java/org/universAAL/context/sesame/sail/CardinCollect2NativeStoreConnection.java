...
public class CardinCollect2NativeStoreConnection extends CardinalityNativeStoreConnection {
	...
	protected CardinCollect2NativeStoreConnection(CardinalityNativeStore nativeStore) throws IOException {
		super(nativeStore);
	}
	...
	private boolean prevObjIsClosedCollection(Resource subj, URI pred, Resource[] contexts) throws SailException {
