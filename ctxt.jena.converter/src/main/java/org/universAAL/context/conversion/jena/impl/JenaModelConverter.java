...
public class JenaModelConverter implements JenaConverter {
	...
	private boolean checkEquality(int maxCard, com.hp.hpl.jena.rdf.model.Resource sink, com.hp.hpl.jena.rdf.model.Resource src) {
		// the 'equals' method of Resource can also check the equality of two anon resources
...
//	}
	...
	private Object deserialize(String serialized, boolean wasXMLLiteral) {
		...
		try {
			...
			Resource result = getResource(getJenaRootResource(m), new Hashtable(),
					wasXMLLiteral);
			if (Resource.TYPE_RDF_LIST.equals(result.getType())) {
				...
				if (rest != null  &&  rest.toString().equals(Resource.RDF_EMPTY_LIST))
	...
	private Resource getResource(com.hp.hpl.jena.rdf.model.Resource r, Hashtable resources,
	...
	private RDFNode getRDFNode(Model m, Object o, boolean reduced,
		 ...
		 * o).serializesAsXMLLiteral()? ((((Resource) o).isAnon() ||
		 * ((Resource) o).numberOfProperties() > 0)?
		 * m.createTypedLiteral(serialize(o), XMLLiteralType.theXMLLiteralType)
		 * : m.createTypedLiteral(((Resource) o).getURI(),
		 * XSDDatatype.XSDanyURI)) : addDescription(m, (Resource) o, reduced,
	...
	private Resource getUnmanagedResource(com.hp.hpl.jena.rdf.model.Resource r, Hashtable resources,
			boolean wasXMLLiteral) {
		String uri = r.isAnon() ? r.getId().getLabelString() : r.getURI();
	...
	private boolean handleObjectValue(RDFNode n, List l, Hashtable resources) {
		if (n.isLiteral()) {
			...
			if (o instanceof Resource)
				...
				o = getResource(((com.hp.hpl.jena.rdf.model.Resource) n), resources, false);
				if (o instanceof Resource)
					l.add(o);
				else
					return false;
	...
	private boolean processProperties(Resource pr, com.hp.hpl.jena.rdf.model.Resource jr,
			Hashtable resources) {
...
//								if (RDF.nil.getURI().equals(srcList.getURI()))
	...
	public static Resource getResourceInstance(String classURI, String instanceURI) {
